$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Arty et Magesh se marient ",

            // Event start date
            start: new Date('Jun 7, 2024 19:00'),
            ...
            end: new Date('Jun 8, 2024 03:00'),

            // Event Address
            address: 'Château des hauts de provins',

            // Event Description
            description: "On a hâte de vous voir, si vous avez un souci merci de contacter X au XXXXXXXX."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Une seconde!</strong> En cours de sauvegarde.'));

        if (MD5($('#invite_code').val()) !== 'b59c67bf196a4758191e42f76670ceba'
            && MD5($('#invite_code').val()) !== '934b535800b1cba8f96a5d72f72f1611') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Un souci!</strong> Le code est incorrecte.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbxJwrLLcqQF7Oo62UIKA-cONnBVCjvvhMwaZ9bDAzQAGY8AmKFibPFnZ87br3YyVh-M/exec', data)
                .done(function (data) {
                    console.log(data);
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Un souci!</strong> Une erreur de communication avec le serveur. '));
                });
        }
    });
...
var toggleSwitch = function() {
    ...
    toggleContainer.style.backgroundColor = toggleContainer.style.backgroundColor === 'rgb(55, 156, 224)' ? '#ab0707' : '#379ce0';
}
